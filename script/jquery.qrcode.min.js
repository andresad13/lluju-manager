		...
		return this.each(function() {
			...
			if ("canvas" == h.render) {
				...
				for (var d = c.getContext("2d"), b = h.width / a.getModuleCount(), e = h.height / a.getModuleCount(), f = 0; f < a.getModuleCount(); f++) for (var i = 0; i < a.getModuleCount(); i++) {
					...
					d.fillRect(Math.round(i * b)+8, Math.round(f * e)+8, g, j)
				}
				...
				d.lineJoin = "round"; 
				d.lineWidth = 6; 
				d.strokeRect(4,4,c.width-8,c.height-8);

				//增加文字信息
//				d.fillStyle = "#000000";			//文字颜色
//				d.font = "20px '方正粗宋_GBK'";		//文字字体
//				d.textAlign="center";				//文字剧中
//				//shadowBlur:模式级数 
//				d.shadowBlur = 0;					//阴影大小
//				d.shadowOffsetX = 0;				//阴影x的值
//				d.shadowOffsetY = 0;				//阴影Y的值
//				d.shadowColor = "black"; 
				
				//fillText("要添加的文字",x0坐标，y0坐标) 
				var str = h.text;
				
				//d.fillText(str.substring(str.lastIndexOf('/')+1),c.width / 2,c.height-12);
